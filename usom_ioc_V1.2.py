...
zaman_dakika = input("Kaç dakika geriye gitmek istersiniz? (Varsayılan: 0): ")
zaman_saat = input("Kaç saat geriye gitmek istersiniz? (Varsayılan: 0): ")
zaman_gun = input("Kaç gün geriye gitmek istersiniz? (Varsayılan: 0): ")
zaman_ay = input("Kaç ay geriye gitmek istersiniz? (Varsayılan: 0): ")
zaman_yil = input("Kaç yıl geriye gitmek istersiniz? (Varsayılan: 0): ")

zaman_dakika = int(zaman_dakika) if zaman_dakika else 0
zaman_saat = int(zaman_saat) if zaman_saat else 0
zaman_ay = int(zaman_ay) if zaman_ay else 0
